...
unset ttics
set title "Scalability 100K chromosomes (10 iter, 500 nodes)"
...
GNUTERM = "qt"
GPFUN_f = "f(x) = x"
array scal100000[2] = [398423,501047]
## Last datafile plotted: "benchmark-100000.txt"
plot for [IDX=0:1] "data/benchmark-100000.txt" i IDX u 1:(scal100000[IDX+1]/$2) title columnheader(1) w lines smooth bezier dashtype IDX+7 lw 3, f(x) t "ideal" dashtype 1 lw 1.5
