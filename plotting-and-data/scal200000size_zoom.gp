...
unset ttics
set title "Scalability 200K chromosomes (10 iter, 500 nodes)"
...
set xrange [ 0 : 250 ] noreverse nowriteback
...
GNUTERM = "qt"
GPFUN_f = "f(x) = x"
array scal200000[2] = [1520045,1919596]
## Last datafile plotted: "benchmark-200000.txt"
plot for [IDX=0:1] "data/benchmark-200000.txt" i IDX u 1:(scal200000[IDX+1]/$2) title columnheader(1) w lines smooth bezier dashtype IDX+7 lw 3, f(x) t "ideal" dashtype 1 lw 1.5
