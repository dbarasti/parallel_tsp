...
unset ttics
set title "Scalability 50K chromosomes (10 iter, 500 nodes)"
...
GNUTERM = "qt"
GPFUN_f = "f(x) = x"
array scal50000[2] = [113816,138842]
## Last datafile plotted: "benchmark-50000.txt"
plot for [IDX=0:1] "data/benchmark-50000.txt" i IDX u 1:(scal50000[IDX+1]/$2) title columnheader(1) w lines smooth bezier dashtype IDX+7 lw 3, f(x) t "ideal" dashtype 1 lw 1.5
