...
unset ttics
set title "Speedup 200K chromosomes (10 iter, 500 nodes)"
...
plot for [IDX=0:1] "data/benchmark-200000.txt" i IDX u 1:(seq200000/$2) title columnheader(1) w lines smooth bezier dashtype IDX+7 lw 3, f(x) t "ideal" dashtype 1 lw 1.5, maxSp(x) t "max speedup" dashtype 4 lw 1.5
#    EOF
